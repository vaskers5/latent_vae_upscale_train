"""Legacy configuration objects retained for auxiliary utilities.

This module preserves the previous high-level configuration dataclasses used
for the bespoke training pipeline. New training flows should use
``training.config.TrainingConfig`` instead, which now wraps BasicSR configs
